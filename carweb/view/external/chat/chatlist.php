...
<link rel="stylesheet"
	href="/carWeb/view/resource/mobile/css/framework-extend.css" />
<link rel="stylesheet" href="/carWeb/view/resource/mobile/css/scale.css" type="text/css" />
...
<body>
		...
		<div id="chatlist" class="page page-current">
			<header class="bar bar-nav">
				...
				<div class="chat-refresh">
					<a href="#" id="refresh"><i class="icon icon-form-refresh"></i></a>
				</div>
			</header>
	...
	<script src="/carWeb/view/resource/mobile/js/sm-customer.js"></script>	
	...
	<script src="/carWeb/view/resource/websocket/stomp.js"
		type="text/javascript"></script>
	<script src="/carWeb/view/resource/mobile/js/scale.js"></script>
	<script src="/carWeb/view/resource/js/sys/hashmap.js"
		type="text/javascript"></script>
	<script src="/carWeb/view/external/chat/js/emojiFace.js"
		type="text/javascript"></script>
