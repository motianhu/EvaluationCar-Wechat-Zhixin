(function($, window) {
	...
	// $.ajax({
	// url : requestContextPath + "/user/addoa.html",
	// type: "POST",
	// data : {
	...
	function showRecord(id, $record) {
		...
		Util.ajax({
			url : requestContextPath + "/user/getUserOpRecord.html",
			data : {
				"id" : id
			},
			dataType : "json",
	...
	window.exportData = function() {
		...
		Util.ajax({
			url : requestContextPath + "/user/exportUserData.html",
			data : getParam(),
			cache : false,
			dataType : "text",
			success : function(data) {
	...
	$table.on("click", '#user_detail_btnSave', function(e) {
		 ...
		 */
		$.ajax({
			url : requestContextPath + "/user/editoa.html",
			type : "POST",
			data : {
				'id' : id,
	...
	$table.on("click", '#edit_reset_password', function(e) {
		...
		$.ajax({
			url : requestContextPath + "/user/resetUserPassword.html",
			data : {
				'ids' : ids,
			},
			dataType : "json",
	...
	$table.on("click", '#edit_unlock', function(e) {
		...
		$.ajax({
			url : requestContextPath + "/user/unLockUser.html",
			data : {
				'englishName' : englishname,
			},
			dataType : "json",
