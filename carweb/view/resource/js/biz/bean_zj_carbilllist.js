~function($, window) {
	 ...
	 */
	$jTable = $table.table({
		ajaxUrl : requestContextPath + "/carBill/getZjBillList.html",
		paramsJson : getParam(),
		pageKey : {
			total : "total",
			pageSize : "pageSize",
							...
							if (!data.success) {
								...
								$editFrame
										.attr(
												"src",
												requestContextPath
														+ "/view/admin/canvas/zj_carbilldetail.jsp?carBillId="
														+ carBillId);
