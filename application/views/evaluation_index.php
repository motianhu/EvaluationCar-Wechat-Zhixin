		    ...
		    <div class="pg_conbody pricelist">
				<ul class="datalist_page">
					...
					<li i_type="车体骨架" i_no="2">
						...
						<span class="pg_tigle"><red>*</red>2.右侧内轨</span>
					</li>
					...
					<li i_type="车体骨架" i_no="4">
						...
						<span class="pg_tigle"><red>*</red>4.左侧内轨</span>
					</li>
					...
					<li i_type="车体骨架" i_no="8">
						...
						<span class="pg_tigle">8.左后门</span>
					</li>
					...
					<li i_type="车体骨架" i_no="13">
						...
						<span class="pg_tigle">13.右后门</span>
					</li>
            ...
            success: function (res) {
	            ...
	            $.get("<?php echo base_url().'index.php/evaluation/down_image/';?>"+res.serverId+'/'+i_type+'/'+i_no,function(msg){
					if(msg == 'success'){
						...
						dialog({
							content:i_type+'第'+i_no+'张图片上传失败，请重新上传.',
							okValue:'本地上传',
							ok:function(){
								var url = "<?php echo base_url().'index.php/evaluation/up_image/';?>"+i_type+'/'+i_no;
...
$('#pg_submit').click(function(){
	...
	$('red').each(function(){
		...
		if(recat.test(img)){
			var d = dialog({
				content:up_img.parent('li').attr('i_type')+'第'+up_img.parent('li').attr('i_no')+'张图片没有上传.',
				cancelValue: '确定',
				cancel: function () {}
			});
			d.show();	
